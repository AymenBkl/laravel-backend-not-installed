...
class CategoriesController extends Controller
{
  ...
  public function insert(Request $request){
        ...
        $uploadImage1 = $request->image_id1;
        $uploadIcon  = $request->image_icone;
        $uploadIcon1  = $request->image_icone1;
        $categories_status  = $request->categories_status;

        $categories_id = $this->Categories->insert($uploadImage,$date_added,$parent_id,$uploadIcon,$categories_status,$uploadImage1,$uploadIcon1);
        $slug_flag = false;
  ...
  //  dd($editSubCategory[0]->parent_id);
   ...
   public function update(Request $request){
     ...
     if($request->image_id1!==null){
      $uploadImage1 = $request->image_id1;
      }else{
      $uploadImage1 = $request->oldImage1;
    }
     ...
     if(($request->image_icone1) !==null){
      $uploadIcon1 = $request->image_icone1;
  }	else{
      $uploadIcon1 = $request->oldIcon1;
  }

     $updateCategory = $this->Categories->updaterecord($categories_id,$uploadImage,$uploadIcon,$last_modified,$parent_id,$slug,$categories_status,$uploadImage1,$uploadIcon1);
