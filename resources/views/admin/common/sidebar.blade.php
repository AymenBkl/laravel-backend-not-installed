<aside class="main-sidebar">
  ...
  <span>{{ trans('labels.link_reports') }}</span> <i class="fa fa-angle-left pull-right"></i>
      ...
      <?php
        ...
        ?>
          <li class="treeview {{ Request::is('admin/regions/display') ? 'active' : '' }} {{ Request::is('admin/regions/add') ? 'active' : '' }} {{ Request::is('admin/regions/edit/*') ? 'active' : '' }} {{ Request::is('admin/zones/display') ? 'active' : '' }} {{ Request::is('admin/zones/add') ? 'active' : '' }} {{ Request::is('admin/zones/edit/*') ? 'active' : '' }} {{ Request::is('admin/tax/taxclass/display') ? 'active' : '' }} {{ Request::is('admin/tax/taxclass/add') ? 'active' : '' }} {{ Request::is('admin/tax/taxclass/edit/*') ? 'active' : '' }} {{ Request::is('admin/tax/taxrates/display') ? 'active' : '' }} {{ Request::is('admin/tax/taxrates/add') ? 'active' : '' }} {{ Request::is('admin/tax/taxrates/edit/*') ? 'active' : '' }}">
            <a href="#">
              <i class="fa fa-money" aria-hidden="true"></i>
              <span>{{ trans('labels.link_tax_location') }}</span> <i class="fa fa-angle-left pull-right"></i>
            </a>
            <ul class="treeview-menu">
              <li class="{{ Request::is('admin/regions/display') ? 'active' : '' }} {{ Request::is('admin/regions/add') ? 'active' : '' }} {{ Request::is('admin/regions/edit/*') ? 'active' : '' }} "><a href="{{ URL::to('admin/regions/display')}}"><i class="fa fa-circle-o"></i> {{ trans('labels.link_regions') }}</a></li>
