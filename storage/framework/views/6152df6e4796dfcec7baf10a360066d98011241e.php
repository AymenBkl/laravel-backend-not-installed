                    ...
                    <div class="box">
                        <div class="box-header">
                            <div class="col-lg-6 form-inline" id="contact-form">
                                <form  name='registration' id="registration" class="registration" method="get" action="<?php echo e(url('admin/regions/filter')); ?>">
                                    ...
                                    <div class="input-group-form search-panel ">
                                        ...
                                        <?php if(isset($param,$name)): ?>  <a class="btn btn-danger " href="<?php echo e(url('admin/regions/display')); ?>"><i class="fa fa-ban" aria-hidden="true"></i> </a><?php endif; ?>
                                    </div>
                                </form>
                                <div class="col-lg-4 form-inline" id="contact-form12"></div>
                            </div>
                            <div class="box-tools pull-right">
                                <a href="<?php echo e(url('admin/regions/add')); ?>" type="button" class="btn btn-block btn-primary"><?php echo e(trans('labels.AddNew')); ?></a>
                            </div>
                        </div>
                                ...
                                <div class="col-xs-12">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <th><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('countries_name', trans('labels.RegionName')));?></th>
                                        ...
                                        <?php if(count($countryData['countries'])>0): ?>
                                            <?php $__currentLoopData = $countryData['countries']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$countries): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td><a data-toggle="tooltip" data-placement="bottom" title="<?php echo e(trans('labels.Edit')); ?>" href="<?php echo e(url('admin/regions/edit',$id)); ?>" class="badge bg-light-blue"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="deleteCountryModalLabel"><?php echo e(trans('labels.DeleteRegion')); ?></h4>
                        </div>
                        <?php echo Form::open(array('url' =>'admin/regions/delete', 'name'=>'deleteCountry', 'id'=>'deleteCountry', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')); ?>
                        ...
                        <div class="modal-body">
                            <p><?php echo e(trans('labels.DeleteRegionText')); ?></p>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo e(trans('labels.Close')); ?></button>
                            <button type="submit" class="btn btn-primary" id="deleteCountry"><?php echo e(trans('labels.DeleteRegion')); ?></button>
                        </div>
                        <?php echo Form::close(); ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Freelancer\LAravel Ionic Fish\LaravelWebsite&AdminCode\website_adminpanel\resources\views/admin/countries/index.blade.php ENDPATH**/ ?>