                                ...
                                <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="col-xs-12 col-md-6">
                                                ...
                                                <label for="name" class="col-sm-2 col-md-3 control-label"><?php echo e(trans('labels.Region')); ?></label>
                                            ...
                                            <div class="col-sm-10 col-md-4">
                                                ...
                                                <div class="col-xs-12 col-md-6">
                                                <div class="form-group">
                                                <label for="name" class="col-sm-2 col-md-3 control-label"><?php echo e(trans('labels.ZoneName')); ?></label>

                                            <div class="col-sm-10 col-md-4">


                                                    <select name="zone_country_id" class='form-control' id="zone_country_id">
                                                        <?php $__currentLoopData = $result['zones']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $zones_data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($zones_data->zone_id); ?>" <?php echo e(($zones_data->zone_id == $result['product'][0]->zone_id) ? 'selected' : ''); ?>> <?php echo e($zones_data->zone_name); ?> </option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </select>
                                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                                      <?php echo e(trans('labels.ChooseZoneRegion')); ?></span>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Freelancer\LAravel Ionic Fish\LaravelWebsite&AdminCode\website_adminpanel\resources\views/admin/products/edit.blade.php ENDPATH**/ ?>