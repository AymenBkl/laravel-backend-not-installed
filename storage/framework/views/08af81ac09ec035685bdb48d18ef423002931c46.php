<aside class="main-sidebar">
  ...
  <span><?php echo e(trans('labels.link_reports')); ?></span> <i class="fa fa-angle-left pull-right"></i>
      ...
      <?php
        ...
        ?>
          <li class="treeview <?php echo e(Request::is('admin/regions/display') ? 'active' : ''); ?> <?php echo e(Request::is('admin/regions/add') ? 'active' : ''); ?> <?php echo e(Request::is('admin/regions/edit/*') ? 'active' : ''); ?> <?php echo e(Request::is('admin/zones/display') ? 'active' : ''); ?> <?php echo e(Request::is('admin/zones/add') ? 'active' : ''); ?> <?php echo e(Request::is('admin/zones/edit/*') ? 'active' : ''); ?> <?php echo e(Request::is('admin/tax/taxclass/display') ? 'active' : ''); ?> <?php echo e(Request::is('admin/tax/taxclass/add') ? 'active' : ''); ?> <?php echo e(Request::is('admin/tax/taxclass/edit/*') ? 'active' : ''); ?> <?php echo e(Request::is('admin/tax/taxrates/display') ? 'active' : ''); ?> <?php echo e(Request::is('admin/tax/taxrates/add') ? 'active' : ''); ?> <?php echo e(Request::is('admin/tax/taxrates/edit/*') ? 'active' : ''); ?>">
            <a href="#">
              <i class="fa fa-money" aria-hidden="true"></i>
              <span><?php echo e(trans('labels.link_tax_location')); ?></span> <i class="fa fa-angle-left pull-right"></i>
            </a>
            <ul class="treeview-menu">
              <li class="<?php echo e(Request::is('admin/regions/display') ? 'active' : ''); ?> <?php echo e(Request::is('admin/regions/add') ? 'active' : ''); ?> <?php echo e(Request::is('admin/regions/edit/*') ? 'active' : ''); ?> "><a href="<?php echo e(URL::to('admin/regions/display')); ?>"><i class="fa fa-circle-o"></i> <?php echo e(trans('labels.link_regions')); ?></a></li>
...
<?php /**PATH D:\Freelancer\LAravel Ionic Fish\LaravelWebsite&AdminCode\website_adminpanel\resources\views/admin/common/sidebar.blade.php ENDPATH**/ ?>